...
from EnneadTab import ERROR_HANDLE, SHAREPOINT
...
EXCEL_PATH = SHAREPOINT.get_project_file("1643/2_Master File/B-70_Programming/01_Program & Analysis/2024-05-07 Color Scheme_LHH.xls")
